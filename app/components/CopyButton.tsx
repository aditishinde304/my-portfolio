...
export default function CopyButton({ text }: { text: string }) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center transition-colors duration-150 cursor-pointer ml-1"
      style={{ color: copied ? "#3b82f6" : "var(--muted)", verticalAlign: "middle" }}
    >
      {copied ? (
        // Checkmark
